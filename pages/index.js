...
export default function Home() {
  ...
  return (
    <Layout
      title="Home — SecuFlow"
      description="Welcome to SecuFlow."
    >
      {/* Hero Section */}
      ...
      <div className="z-0 grid grid-cols-12 gap-4 min-h-[1000px]">
        ...
        {/* Visualiser */}
        <section className="col-span-12 xl:col-span-6 p-4">
          <h2 className="font-bold mb-4">Visualiser</h2>
          <div className="bg-white shadow rounded-lg p-6">
            {/* Graph / Heatmap Component */}
            <div className="text-center">[Graph Visualization]</div>
          </div>
        </section>
